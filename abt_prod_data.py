...
df_ativos = pd.read_excel('./database/ativos_2023_02.xlsx', dtype={'cod_chapa_funcionario' : object})
df_beneficios = pd.read_excel('./database/beneficios_2023_02.xlsx', dtype={'cod_chapa_funcionario' : object})
df_dependentes = pd.read_excel('./database/dependentes_2023_02.xlsx', dtype={'cod_chapa_funcionario' : object})
df_multiplos = pd.read_excel('./database/multiplos_2023_02.xlsx', dtype={'cod_chapa_funcionario' : object})
...
selection = (df['Ano/Mês'] == '2023/02') | (df['dsc_iniciativa_desligamento'] != 'NAO INFORMADO')
df = df[selection]

# Keep only active employees
selection = (df['dsc_iniciativa_desligamento'] == 'NAO INFORMADO')
df = df[selection]
...
file_name = './database/abt_prod_data.csv'
